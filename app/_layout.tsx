  ...
  return (
    <>
      ...
      <Stack>
        ...
        <Stack.Screen name="accountSetting/editProfile/editProfilesPage" options={{ headerShown: false }} />
        <Stack.Screen name="accountSetting/changePassword/changePasswordPage" options={{ headerShown: false }} />
      </Stack>
